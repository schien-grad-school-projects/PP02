...
public class DataEntries {
    ...
    public static int intInputSize(int s, String m) {
        ...
        while (true) {
            try {
                ...
                if (custIdStr.length() != s) throw new NumberFormatException();
    ...
    public static int intInputChoice(int c1, int c2, String m) {
        ...
        while (true) {
            try {
                ...
                if ((intUserInput != c1) && (intUserInput != c2)) throw new NumberFormatException();
    ...
    public static int intInputRange(int start, int end, String m) {
        ...
        while (true) {
            try {
                ...
                if ((intUserInput > end) || (intUserInput < start)) throw new NumberFormatException();
    ...
    public static double doubleInput(String m) {
        ...
        while (choice == JOptionPane.YES_OPTION) {
            try {
                dbUserInput = Double.parseDouble(JOptionPane.showInputDialog(m));

                if (dbUserInput < 1) throw new NumberFormatException();
    ...
    public static long longInput(String m) {
        int choice = 0;
        long dbUserInput = 0;
        while (choice == JOptionPane.YES_OPTION) {
            try {
                dbUserInput = Long.parseLong(JOptionPane.showInputDialog(m));
    ...
    public static String strInput(String m) {
        ...
        while (true) {
            ...
            if (strUserInput.isEmpty()) JOptionPane.showMessageDialog(null, "Invalid " + m + " Format");
            else break;
